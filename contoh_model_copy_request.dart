...
class ContohModelCopy {
  ...
  factory ContohModelCopy.fromMap(Map<String, dynamic> map) {
    return ContohModelCopy(
      userId: map['userId'],
      id: map['id'],
      title: map['title'],
      ...
      dataSederhana: List<DataSederhana>.from(
          map['dataSederhana']?.map((x) => DataSederhana.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory ContohModelCopy.fromJson(String source) =>
      ContohModelCopy.fromMap(json.decode(source));
}
...
class DataField {
  ...
  factory DataField.fromJson(String source) =>
      DataField.fromMap(json.decode(source));
}
...
class Datadata {
  ...
  factory Datadata.fromJson(String source) =>
      Datadata.fromMap(json.decode(source));
}
...
class DimanaBosku {
  ...
  factory DimanaBosku.fromMap(Map<String, dynamic> map) {
    return DimanaBosku(
      okeemantap: map['okeemantap'],
    );
  }

  String toJson() => json.encode(toMap());

  factory DimanaBosku.fromJson(String source) =>
      DimanaBosku.fromMap(json.decode(source));
}
...
class DataSederhana {
  ...
  factory DataSederhana.fromMap(Map<String, dynamic> map) {
    return DataSederhana(
      dataku: map['dataku'],
      valueku: map['valueku'],
      hasilDataku: map['hasilDataku'],
      adaDataku: AdaDataku.fromMap(map['adaDataku']),
      tidakAda:
          List<TidakAda>.from(map['tidakAda']?.map((x) => TidakAda.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory DataSederhana.fromJson(String source) =>
      DataSederhana.fromMap(json.decode(source));
}
...
class AdaDataku {
  ...
  factory AdaDataku.fromMap(Map<String, dynamic> map) {
    return AdaDataku(
      okeeSiapp: map['okeeSiapp'],
      siapapanya: map['siapapanya'],
    );
  }

  String toJson() => json.encode(toMap());

  factory AdaDataku.fromJson(String source) =>
      AdaDataku.fromMap(json.decode(source));
}
...
class TidakAda {
  ...
  factory TidakAda.fromJson(String source) =>
      TidakAda.fromMap(json.decode(source));
}
...
class CobainDeh {
  ...
  factory CobainDeh.fromJson(String source) =>
      CobainDeh.fromMap(json.decode(source));
}
...
class Okeboss {
  ...
  factory Okeboss.fromMap(Map<String, dynamic> map) {
    return Okeboss(
      siapp: map['siapp'],
      dimanaBoss: List<DimanaBoss>.from(
          map['dimanaBoss']?.map((x) => DimanaBoss.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory Okeboss.fromJson(String source) =>
      Okeboss.fromMap(json.decode(source));
}
...
class DimanaBoss {
  ...
  factory DimanaBoss.fromJson(String source) =>
      DimanaBoss.fromMap(json.decode(source));
}
...
class Sub {
  ...
  factory Sub.fromMap(Map<String, dynamic> map) {
    return Sub(
      ...
      okeeboss:
          List<Okeeboss>.from(map['okeeboss']?.map((x) => Okeeboss.fromMap(x))),
    );
  }
...
class Okeeboss {
  ...
  factory Okeeboss.fromJson(String source) =>
      Okeeboss.fromMap(json.decode(source));
}
